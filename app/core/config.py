...
class Settings(BaseSettings):
    ...
    VLM_BASE_URL: Optional[str] = None  # 默认使用 OpenAI GPT-4o
    ...
    # --- 🚀 [V43.5] 推理集群标准化接口 ---
    SLM_API_URL: str = "http://127.0.0.1:30001/v1"
    SLM_MODEL_NAME: str = "/app/models/qwen-1.5b"
    OCR_API_URL: str = "http://127.0.0.1:30000/v1/chat/completions"
